// data/entities.js
// الكيانات غير الطبيعية: الكيانات الأرثوذكسية والشريرة، والأباطرة القدامى، وكائنات أخرى.
...
(function (g) {
  ...
  L.entities = [
    ...
    // ── الكيانات الأرثوذكسية السبع (القارة الشمالية) ──────────────────────────
    {
      ...
      events: [
        { chapter: 14, type: 'mention', text: 'إحدى الكيانات الأرثوذكسية المعروفة في القارة الشمالية.',
          quote: 'إلهة الليل الدائم' },
      ],
      blurb_ar: 'إحدى الكيانات الأرثوذكسية السبع في القارة الشمالية؛ ترتبط بها كنيسة إلهة الليل الدائم ومسار اللانائم.',
      sources: [14],
    },
    {
      id: 'lord_of_storms',
      ...
      events: [
        { chapter: 265, type: 'lore', text: 'أحد الكيانات الأرثوذكسية السبعة النشطة في الحقبة الرابعة (عصر الآلهة).',
          quote: 'الآلهة الأرثوذكسية السبعة' },
      ],
      blurb_ar: 'أحد الكيانات الأرثوذكسية السبع في القارة الشمالية؛ تتبعه كنيسة لورد العواصف (سيد العواصف).',
      sources: [94, 265],
    },
    {
      id: 'god_of_steam',
      ...
      blurb_ar: 'أحد الكيانات الأرثوذكسية السبع؛ عُرف قديمًا بـ«إله الحرف اليدوية» قبل أن يُعاد تأسيس عبادته بوصفه إله البخار والآلات.',
      sources: [134],
    },
    {
      id: 'god_of_knowledge',
      ...
      events: [
        { chapter: 265, type: 'lore', text: 'أحد الكيانات الأرثوذكسية السبعة النشطة في الحقبة الرابعة.',
          quote: 'الآلهة الأرثوذكسية السبعة' },
      ],
      blurb_ar: 'أحد الكيانات الأرثوذكسية السبع في القارة الشمالية؛ تتبعه كنيسة إله المعرفة والحكمة، وتُعدّ من أقدم المنظمات الخفية.',
      sources: [94, 265],
    },
    {
      id: 'god_of_combat',
      ...
      events: [
        { chapter: 265, type: 'lore', text: 'أحد الكيانات الأرثوذكسية السبعة النشطة في عصر الآلهة (الحقبة الرابعة).',
          quote: 'الآلهة الأرثوذكسية السبعة' },
      ],
      blurb_ar: 'أحد الكيانات الأرثوذكسية السبع؛ يرتبط بمسار العملاق (العمالقة أحاديي العين في الحقبة الثانية).',
      sources: [265],
    },
    {
      id: 'mother_earth',
      ...
      events: [
        { chapter: 265, type: 'lore', text: 'إحدى الكيانات الأرثوذكسية السبعة النشطة في عصر الآلهة.',
          quote: 'الآلهة الأرثوذكسية السبعة' },
      ],
      blurb_ar: 'إحدى الكيانات الأرثوذكسية السبع في القارة الشمالية؛ كيان الأرض والخِصب.',
      sources: [94, 265],
    },
    {
      ...
      blurb_ar: 'أحد الكيانات الأرثوذكسية السبع؛ كنيسته الأقوى نفوذًا في القارة الشمالية، وعرفت بقمعها لكنيسة إله الحرف اليدوية قديمًا.',
      sources: [134],
    },
    ...
    // ── الآلهة الشريرة ────────────────────────────────────────────────────
    {
      ...
      events: [
        { chapter: 161, type: 'cataclysm', text: 'الكيان الشرير «الموت» مذكور في سجلات صقور الليل وكتاب وحي الليل الدائم في سياق كارثة نهاية الحقبة الرابعة (الحقبة الشاحبة).',
          quote: 'صفقة مع الموت' },
        { chapter: 265, type: 'lore', text: 'أحد الآلهة الشريرة النشطة في عصر الآلهة.',
          quote: 'الموت، الشيطانة البدائية' },
      ],
      blurb_ar: 'كيان شرير؛ تسبب في كارثة أنهت الحقبة الرابعة (عصر الآلهة) فعُرفت نهايتها بالحقبة الشاحبة. تعبده منظمتا النظام الثيوصوفي والأسقفية المقدسة.',
      sources: [161, 265],
    },
    {
      ...
      blurb_ar: 'كيان شرير نشط في الحقبة الرابعة؛ تعبده طائفة الشيطانة («عائلة الشيطانة» قديمًا) وتسيطر على مسار القاتل، وجميع كبار أتباعها من النساء.',
      sources: [265],
    },
    {
      id: 'true_creator',
      ...
      blurb_ar: 'كيان شرير تؤمن به بعض النظم السرية الحديثة (نظام الشفق، صليب الحديد والدم) التي ظهرت في القرون الأخيرة. في قوس باكلوند يصير لانيفوس وعاءً لقداسته.',
      sources: [88, 285],
    },
    ...
    // ── batch-ch238/313: تنين الخيال أنكويلت (Dragon of Imagination) — ancient Dragon King of the Second Epoch ──
    {
      id: 'dragon_of_imagination',
      name_ar: 'تنين الخيال، أنكويلت', name_en: 'Dragon of Imagination (Anquilut)',
      kind: 'ancient',
      first_appeared_chapter: 238, status: 'dead',
      first_appeared_quote: 'تنين الخيال',
      pathway: { id: 'spectator', name_ar: 'مسار المتفرّج (مسار التنين)' },
      aliases: [
        { name: 'أنكويلت', since_chapter: 238, quote: 'أنكويلت' },
        { name: 'ملك التنانين', since_chapter: 238, quote: 'ملك التنانين' },
      ],
      states: [
        { since_chapter: 238, role: 'ملك التنانين (تنين الخيال)', domain: 'السماء والأرض والمحيط (الحقبة الثانية)',
          notes: 'أقوى التنانين وأكثرها رعباً؛ مسار المتفرّج (مسار التنين) ينبع من عرق تنين العقل وكان أنكويلت ممثلهم. كل ما يتخيله يظهر، والمستقبل الذي يعلنه يصير حقيقة.' },
      ],
      events: [
        { chapter: 238, type: 'intro', text: 'كشف من أساطير مدينة الفضة: أقوى التنانين وأكثرها رعباً هو ملك التنانين أنكويلت، المعروف أيضاً بتنين الخيال — من الحقبة الثانية.',
          quote: 'ملك التنانين' },
        { chapter: 238, type: 'ability', text: 'قدرته: كل ما يتخيله يظهر، والمملكة التي يتخيلها تنزل إلى العالم المادي، والمستقبل الذي يعلنه يصير حقيقة.',
          quote: 'كل ما يتخيله سيظهر' },
        { chapter: 238, type: 'pathway', text: 'مسار المتفرّج (الذي يسميه أهل مدينة الفضة "مسار التنين") ينبع من عرق تنين العقل، وأنكويلت ممثلهم.',
          quote: 'مسار التنين' },
        { chapter: 238, type: 'death', text: 'سقط تنين الخيال (وتنين الكوابيس ألزهود ابنه) حين استيقظ الخالق، فخسروا كل شيء بما في ذلك حياتهم.',
          quote: 'استيقظ الخالق، وسقط تنين الخيال' },
        { chapter: 238, type: 'artifact_link', text: 'وصف تنين الخيال جعل كلاين يفكر في التحفة الأثرية المختومة 0-08 (الريشة) — المستقبل المعلَن يصير حقيقة، "يتقاسمون نفس الخصائص"!',
          quote: 'يتقاسمون نفس الخصائص' },
        { chapter: 313, type: 'lore', text: 'من بين الآلهة القديمة الثمانية الذين اقتسموا سلطة الخالق المتبقية: تنين الخيال أنكويلت، أمراء السماء والأرض والمحيط.',
          quote: 'أنكويلت' },
      ],
