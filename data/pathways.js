  ...
  L.pathways = [
    ...
    // gains demon magic, loses conscience. seq-8 has an old name (القاتل بارد الدم) + modern name.
    {
      ...
      sequences: [
        ...
        // ch335: Seq-6 شيطانة الشهوة (Demoness of Pleasure) — Klein obtains the formula from Sharron's spirit.
        { n: 6, name_ar: 'شيطانة الشهوة', name_en: 'Demoness of Pleasure', known_chapter: 335,
