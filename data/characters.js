  ...
  L.characters = [
    {
      ...
      events: [
        ...
        { chapter: 311, type: 'faction_event', text: 'ضمّ "الساحر" فورس إلى نادي التاروت كعضو جديد (التسلسل 9 من مسار المبتدئ).',
          quote: 'الساحر' },
    ...
    },
    {
      ...
      events: [
        { chapter: 209, type: 'death', text: 'ضحّى بقلبه لإيقاف طفلٍ كيانٍ شرير وتُوفّي — ذروة قوس تينغن',
    ...
    },
    {
      ...
      events: [
        ...
        { chapter: 210, type: 'advance', text: 'تقدّم من التسلسل 5 (حارس البوابة) إلى التسلسل 4 (مراقب الليل) وأصبح نصف كيان بعد أخذ رماد القديسة سيلينا',
      ...
      relationships: [],
      abilities: [],
      tags: ['عدو', 'العقل المدبّر للمجلد الأول', 'مسار الليل الدائم', 'نصف كيان'],
      blurb_ar: 'العقل المدبّر الحقيقي للمجلد الأول — رئيس أساقفة سابق خان كنيسة الليل الدائم. هندس بأكمله قوسَ تينغن عبر التحفة الأثرية المختومة 0.08 (ريشة تكتب أحداثاً مقدَّرة يتبعها الناس لاشعورياً)، وأوصل الأمور حتى حصل على رماد القديسة سيلينا وتقدّم إلى التسلسل 4 ليصبح نصف كيان.',
      sources: [210, 211, 212],
    },
    {
    ...
    },
    {
      ...
      events: [
        ...
        { chapter: 208, text: 'يُصاب إصابة بالغة في المعركة ضد الوحش ميغوس/نسل الكيان الشرير.',
...

    {
      ...
      events: [
        ...
        { chapter: 312, type: 'reveal', text: 'كشف أنها التسلسل 9 "المبتدئ" من مسار المبتدئ، وتطلب شراء تركيبة التسلسل 8 "سيد الخدع"؛ ينزعجها القمر المكتمل — ارتباط رمزي بين مسار المبتدئ والسيد باب.',
          quote: 'المبتدئ' },
      ],
      relationships: [
      ...
      tags: ['نادي التاروت', 'الساحر', 'مسار المبتدئ', 'باكلوند', 'السيد باب'],
    ...
    // ─ـ batch-ch173/200: السيدة شارون — Demoness Sect member in Tingen ──
    {
      ...
      events: [
        ...
        { chapter: 314, type: 'reveal', text: 'ديريك يستنتج أن شارون متجاوزة من مسار العنقاء — يغيّر كلاين ضمير الإشارة إليها من "هي" إلى "هو" (سمة مسار العنقاء).',
          quote: 'مسار العنقاء' },
        { chapter: 331, type: 'lore', text: 'كشف أن كل متجاوزي مسار العنقاء ملعونون ولهم خصائص مجنونة — لعنة المسار التي تصيب شارون وغيرها.',
          quote: 'كل متجاوزي هذا المسار ملعونون' },
        { chapter: 348, type: 'reveal', text: 'تأكيد اسم تسلسلها: "الروح" (التسلسل 5 من مسار العنقاء) — قدرة سيطرة روحية تخدّر عقول الخصوم، غريبة ولا يمكن الدفاع ضدها.',
          quote: 'التسلسل 5 الروح' },
      ],
      relationships: [],
      abilities: [],
      tags: ['حارس شخصي', 'التسلسل 5', 'الروح', 'مسار العنقاء', 'باكلوند'],
      blurb_ar: 'شارون — متجاوزة التسلسل 5 "الروح" من مسار العنقاء، تُعرف بلقب "الأنسة حارس شخصي"؛ استأجرها كلاين لحمايته وساعدته في قتل روزاغوا. ككل متجاوزي مسار العنقاء: ملعونة وذات خصائص مجنونة. جنسها الغامض (يغيّر كلاين ضمير الإشارة من "هي" إلى "هو") من سمات المسار. ترتبط بشعار النبالة للعائلة المالكة ثيودور من الحقبة الرابعة.',
      sources: [248, 251, 277, 278, 302, 314, 331, 348],
    },
  ];
