...
(function (g) {
  ...
  L.meta = {
    ...
    volumes: [
      ...
      { id: 'v3', name_ar: 'المجلد الثالث: المحقق موريارتي (باكلاند)', start_chapter: 280, end_chapter: 324 },
      { id: 'v4', name_ar: 'المجلد الرابع: لا يُسمع صوت في الظلام', start_chapter: 325, end_chapter: 356 },
    ],
  };
